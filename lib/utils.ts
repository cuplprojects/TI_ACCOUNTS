...
let routeConfigs: RouteConfig[] = [
  ...
  { path: "/auth/login", is_protected: false },
  { path: "/auth/register", is_protected: false },
  { path: "/auth/seller/forgot-password", is_protected: false },
  { path: "/auth/seller/change-password", is_protected: false },
