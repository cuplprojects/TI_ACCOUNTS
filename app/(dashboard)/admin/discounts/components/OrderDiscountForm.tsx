...
export default function OrderDiscountForm({ initialData, isDisabled = false }: { initialData?: Discount; isDisabled?: boolean }) {
  ...
  const [discountType, setDiscountType] = useState(
    initialData?.discount_type === "percent" ? "percentage" : "fixed"
  );
  ...
  return (
    <>
      ...
      {/* Discount Value */}
      <div className="mb-6 bg-white rounded-lg p-6 custom-border-1">
        <h3 className="text-gray-700 small-semibold mb-2">
        ...
        <div className="flex gap-2 relative">
          <div className="relative w-48">
            <select
              ...
              disabled={isDisabled}
              className={`appearance-none w-full p-3 custom-border-3 rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary pr-10 ${disabledInputClass}`}
            >
      ...
      <div className="mb-6 bg-white rounded-lg p-6 custom-border-1">
        <h3 className="text-gray-700 xsmall-semibold mb-4">
          Active Dates <span className="text-red-500">*</span>
        </h3>
